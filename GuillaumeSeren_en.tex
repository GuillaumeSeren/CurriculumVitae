...
\section{Training}
\tlcventry{2008}{2009}{J2EE \& .NET training}{+3}{}{CESI school}{Aix-en-Provence}{}
\tlcventry{2005}{2007}{BTS Management Information Systems}{}{Application Developer Option}{Ecole Charlotte Grawitz}{Marseille}{}
...
\cvlistitem{Software Development: Agile, Scrum, TDD, KISS}
\cvlistitem{Modelisation: UML, MERISE, CDM / PDM, design pattern}

\subsection{Operating Systems}
\cvlistitem{Server: Gentoo, Nixos, Debian}

\subsection{Programming languages}
\cvlistitem{Scripting: Bash, Python, Ruby, Lua}
\cvlistitem{Compiled: C/C++, Go, Java}
\cvlistitem{Web: XML, (X)HTML, CSS, JavaScript, PHP, Node.js}

\subsection{Development (Dev)}
\cvlistitem{Script git-hook of pre/post push/commit/*}
\cvlistitem{Script of check (linter,test) of the code validity and code convention}
\cvlistitem{Script of load test, stress test}
\cvlistitem{Script of deployment (local, preprod, prod)}
\cvlistitem{Script of deployement on VCS event (merge/tag/push)}
\cvlistitem{Development of features with tests based on the specifications}
\cvlistitem{Bug fixing and tracking of feedback from users in a BugTracker}

\subsection{Operation (Ops)}
\cvlistitem{Script of backup and synchronisation of production}
\cvlistitem{Setup and optimisation of Web server LAMP (Apache/NGINX)}
\cvlistitem{Setup of production's servers with redundancy (HAProxy)}
\cvlistitem{Setup of Docker's containers architecture (docker-compose)}
\cvlistitem{Software packaging (Gentoo / Debian) followup security and upgrades}
\cvlistitem{Setup application of collaborative development with versioning using agile methodology (Git)}
\cvlistitem{Backport of software upf and fixes, using several branches (stable/testing/unstable)}

\subsection{Security (Sec)}
\cvlistitem{Server Auditing, nmap / metasploit}
\cvlistitem{Server security, fixing issue and refactoring}
