...
\cvlistitem{Git-Hook script on pre/post push/commit/*}
\cvlistitem{Test/Linter script of the code validity and code convention}
\cvlistitem{Load / stress test script}
\cvlistitem{Deployment script (local, preprod, prod)}
\cvlistitem{Deployement on VCS event script (merge/tag/push)}
...
\cvlistitem{Backup and synchronisation script of production}
...
\cvlistitem{Backport of software updates and fixes, using several branches (stable/testing/unstable)}

\subsection{Security (Sec)}
\cvlistitem{Security Auditing, nmap / metasploit}
\cvlistitem{Security flaw analysis, fixing issue and refactoring}
...
\section{Languages}
\cvlanguage{Anglais}{fluent}{Regular practice.}
