...
\cvlistitem{Modélisation: UML, MERISE, MCD / MPD, designs patterns}
...
\cvlistitem{Déploiement automatisé depuis le ci/cd en testing / preprod / production}
\cvlistitem{Mise en place de stack Docker (compose|cloud) de testing / preprod / prod}
