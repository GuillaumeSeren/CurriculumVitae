...
\cvlistitem {Coté - client: JavaScript, Bash, Python, Java / J2EE, Ruby, lua.}
\cvlistitem {Présentation: xml, html, xhtml.}
\cvlistitem {Mise en page: CSS}

\subsection{Systèmes d'exploitation}
\cvlistitem {Serveurs: Debian, BSD, nixOs.}
\cvlistitem {Clients: Debian, *nix.}
\cvlistitem {Mobile: Android.}

\subsection{Administration système}
\cvlistitem {Mise en place de conteneurs Docker de développement LAMP.}
